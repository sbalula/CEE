...
Pode assim escrever-se a matrix de controlabilidade como \eqref{contr}, calculada em {\it Matlab} como se descreve em Listing \ref{list1}.
...
A matrix de observabilidade é dada por \eqref{obsr} 
...
Através do diagrama de Bode da \rfig{../img/BodeMalhaAberta.png} é então possível concluir que o sistema possui 4 pólos como esperado, visto que o motor DC irá introduzir dois pólos (reais) e os dois graus de liberdade da barra irão introduzir outros dois pólos (complexos, um para cada grau de liberdade) .
